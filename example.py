...
X_train, X_valid, y_train, y_valid = train_test_split(
    X_tv, y_tv, test_size=0.5, random_state=42, stratify=y_tv
)
...
model = UnbiasedBoost(
    "logloss", params["n_est"], params["min_leaf"], params["thresh"], 3, params["lr"], 1
)
score, pred = model.fit(
    X_train,
    y_train,
    testset=(metric, X_test, y_test.values),
    mono_h=1,
    large_leaf_reward=params["power"],
    score_type="advance",
)
